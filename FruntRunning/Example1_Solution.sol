...
contract SecureHashGame {
    ...
    /* 
       ...
       The hash is calculated using keccak256(address + solution + secret).
    ...
    */
    function commitSolution(bytes32 _solutionHash) public gameActive {
        require(commits[msg.sender].commitTime == 0, "Solution already committed");
    ...
    */
    ...
    /* 
        ...
        The solution hash is verified using keccak256(address + solution + secret).
    ...
    */
        ...
        gameActive
    {
        ...
        require(
            keccak256(abi.encodePacked(_solution)) == targetHash, "Incorrect solution"
        );
